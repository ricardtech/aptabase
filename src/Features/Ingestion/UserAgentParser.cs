...
public static class UserAgentParser
{
    private static readonly (string pattern, string name)[] LinuxDistros = new[]
    {
        ...
        (@"manjaro(?:[\/\s-]([0-9\._a-zA-Z-]+))?", "Manjaro"),
        (@"arch(?:\s*linux)?(?:[\/\s-]([0-9\._a-zA-Z-]+))?", "Arch Linux"),
        (@"endeavouros(?:[\/\s-]([0-9\._a-zA-Z-]+))?", "EndeavourOS"),
        (@"garuda(?:[\/\s-]([0-9\._a-zA-Z-]+))?", "Garuda Linux"),
        (@"artix(?:[\/\s-]([0-9\._a-zA-Z-]+))?", "Artix Linux"),
        (@"ubuntu(?:[\/\s-]([0-9\.]+))?", "Ubuntu"),
        (@"kubuntu(?:[\/\s-]([0-9\.]+))?", "Kubuntu"),
        (@"xubuntu(?:[\/\s-]([0-9\.]+))?", "Xubuntu"),
        (@"lubuntu(?:[\/\s-]([0-9\.]+))?", "Lubuntu"),
        (@"debian(?:[\/\s-]([0-9\.]+))?", "Debian"),
        (@"fedora(?:[\/\s-]([0-9\.]+))?", "Fedora"),
        (@"nobara(?:[\/\s-]([0-9\.]+))?", "Nobara"),
        (@"bazzite(?:[\/\s-]([0-9\.]+))?", "Bazzite"),
        (@"linux\s*mint(?:[\/\s-]([0-9\.]+))?", "Linux Mint"),
        (@"mint(?:[\/\s-]([0-9\.]+))?", "Linux Mint"),
        (@"pop!_os|pop-os(?:[\/\s-]([0-9\.]+))?", "Pop!_OS"),
        (@"zorin(?:[\/\s-]([0-9\.]+))?", "Zorin OS"),
        (@"kali(?:[\/\s-]([0-9\.]+))?", "Kali Linux"),
        (@"parrot(?:[\/\s-]([0-9\.]+))?", "Parrot OS"),
        (@"mx\s*linux|mxlinux(?:[\/\s-]([0-9\.]+))?", "MX Linux"),
        (@"deepin(?:[\/\s-]([0-9\.]+))?", "Deepin"),
        (@"elementary(?:\s*os)?(?:[\/\s-]([0-9\.]+))?", "elementary OS"),
        (@"opensuse(?:[\/\s-]([0-9\.]+))?", "openSUSE"),
        (@"centos(?:[\/\s-]([0-9\.]+))?", "CentOS"),
        (@"red\s*hat|rhel(?:[\/\s-]([0-9\.]+))?", "Red Hat"),
        (@"rocky\s*linux|rocky(?:[\/\s-]([0-9\.]+))?", "Rocky Linux"),
        (@"almalinux|alma(?:[\/\s-]([0-9\.]+))?", "AlmaLinux"),
        (@"gentoo", "Gentoo"),
        (@"alpine", "Alpine Linux"),
        (@"void\s*linux", "Void Linux"),
        (@"slackware(?:[\/\s-]([0-9\.]+))?", "Slackware"),
        (@"solus(?:[\/\s-]([0-9\.]+))?", "Solus"),
        (@"nixos(?:[\/\s-]([0-9\.]+))?", "NixOS"),
        (@"qubes(?:\s*os)?(?:[\/\s-]([0-9\.]+))?", "Qubes OS"),
        (@"tails(?:[\/\s-]([0-9\.]+))?", "Tails"),
